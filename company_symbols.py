...
SECTOR_COMPANIES = {
    ...
    'Energy': {
        ...
        'ONGC.NS': {'weight': 6.5, 'name': 'Oil and Natural Gas'},
        'GAIL.NS': {'weight': 5.2, 'name': 'GAIL India'},
        'IOC.NS': {'weight': 4.1, 'name': 'Indian Oil Corporation'},
        'PETRONET.NS': {'weight': 3.8, 'name': 'Petronet LNG'},
    },
    'FMCG': {
